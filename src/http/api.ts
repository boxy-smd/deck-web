...
export interface ResetPasswordDto {
  /** Token de recuperação de senha recebido por email */
  token: string;
  /**
...
/**
 * Lista todos os rascunhos do usuário autenticado.
...
/**
 * Reporta um comentário inadequado ou ofensivo para moderação.
